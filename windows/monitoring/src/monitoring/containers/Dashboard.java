...
import monitoring.components.Card;
...
public class Dashboard extends Container {
	public Dashboard() {
		...
		column3Center.setHalignment(HPos.CENTER);
			...
			this.getRoot().getChildren().add(dashboardHeading);
			...
			this.getRoot().getChildren().add(sensorDataContainer);
			...
			sensorDataContainer.add(carbonDioxideCard.getContainer(), 2, 0);
		      ...
		      this.getRoot().getChildren().add(linechart);
		      DatePicker date = new DatePicker();
		      
		      this.getRoot().getChildren().add(date);
