...
public class Data{
    ...
    public static List<Data> getAllFromDataLogger(User user, Long dataLoggerID, Date from, Date to) {
    ...
    public static List<Data> getAllFromDataLogger(Long dataLoggerID, GroupAuthentication groupAuthentication, Date from, Date to) {
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm");
